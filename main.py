...
async def start(client, message):
    ...
    if message.chat.type != "private":
        ...
        buttons = [[InlineKeyboardButton("Support", url="https://t.me/dominator_bot_support"),
                    InlineKeyboardButton("Channel", url="https://t.me/dominator_bot_official"),
                    InlineKeyboardButton("Repo", url="https://github.com/dominator454/KukiChatbot")
                    ]]
        Photo = "https://telegra.ph/file/2754e435222a145c28837.jpg"
        await message.reply_photo(Photo, caption=f"Hello [{message.from_user.first_name}](tg://user?id={message.from_user.id}), Machine Learning Chat Bot that can talk about any topic in any language\n /help - Help Commands\n Powered By @dominator_bot_official", reply_markup=InlineKeyboardMarkup(buttons))
